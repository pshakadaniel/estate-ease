...
const About = () => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col items-center justify-center container mx-auto p-14 pt-24 md:px-20 lg:px-32 w-full overflow-hidden"
      id="About"
    >
      <h1 className="text-2xl sm:text-5xl md:text-6xl font-bold mb-2">
        About
